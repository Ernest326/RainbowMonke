...
{
	[BepInPlugin("org.ernest326.gorillatag.rainbowmonke", "Rainbow Monke", "1.0.0")]
	public class RainbowMonke : BaseUnityPlugin
	{
		...
		private void Awake()
		{
			...
			ConfigFile config = new ConfigFile(Path.Combine(Paths.ConfigPath, "RainbowMonke.cfg"), true);
